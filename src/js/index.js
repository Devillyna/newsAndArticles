...
import "@babel/polyfill"; // library for cross browsing
...
function articleGenerator({ title = null, content = null } = {}) {
  ...
  return new Promise((resolve, reject) => {
    ...
    // при вызове функции resolve Promise переходит в состояние "исполнено"
    // и из него возвращается значение переданное в качестве аргумента
    // при вызове функции reject он переходит в состояние "отклонено"
    ...
    acceptButton.addEventListener("click", async () => {
      ...
      //если при редактировании указывается новый файл - записываем его, если нет - берем старый
